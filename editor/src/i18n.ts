...
const zh = {
    ...
    algorithmDetectionFailed: "无法确定统一的算法版本，请检查密码或手动选择版本。",
    algorithm: "算法",
    newTask: "新建任务",
    ...
    selectImage: "选择图片",
    dropImage: "拖入或粘贴图片",
    fileSupport: "支持 PNG、JPEG、WebP、HEIF/HEIC 及剪贴板粘贴，图片仅在本地处理",
    maskingEditor: "打码编辑",
    frequencyImage: "频域图像",
...
const en: Record<keyof typeof zh, string> = {
    ...
    algorithmDetectionFailed: "Could not determine a single algorithm version. Check the password or select a version manually.",
    algorithm: "Algorithm",
    newTask: "New task",
    ...
    fileSupport: "PNG, JPEG, WebP, HEIF/HEIC & clipboard paste supported. Processing stays on this device.",
